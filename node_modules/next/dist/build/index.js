        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
                            ...
                            try {
                                ...
                                let workerResult = await isPageStaticSpan.traceAsyncFn(()=>{
                                    ...
                                    return staticWorkers.isPageStatic({
                                        ...
                                        enableUndici: config.experimental.enableUndici,
                                        locales: (ref = config.i18n) == null ? void 0 : ref.locales,
                                        defaultLocale: (ref11 = config.i18n) == null ? void 0 : ref11.defaultLocale,
                                ...
                                if (pageType === "app" && originalAppPath) {
                                    ...
                                    if ((0, _isEdgeRuntime).isEdgeRuntime(pageRuntime)) {
                                        ...
                                        if ((!(0, _utils).isDynamicRoute(page) || !((ref12 = workerResult.prerenderRoutes) == null ? void 0 : ref12.length)) && ((ref10 = workerResult.appConfig) == null ? void 0 : ref10.revalidate) !== 0) {
            ...
            if (config.experimental.preCompiledNextServer) {
                ...
                await nextBuildSpan.traceChild("trace-next-server").traceAsyncFn(async ()=>{
                    ...
                    const root = (((ref = config.experimental) == null ? void 0 : (ref15 = ref.turbotrace) == null ? void 0 : ref15.contextDirectory) ?? ((ref16 = config.experimental) == null ? void 0 : ref16.outputFileTracingRoot)) ?? dir;
                    const toTrace = [
